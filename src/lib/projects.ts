...
export const projects: Project[] = [
  {
    ...
    title: "Flowers",
    description:
      "A flower breeding genetics simulator built with Ruby on Rails. I built this for myself to help strategize for a blue rose in animal crossing for the switch. Original React+Flask project by me, adapted to Ruby on Rails by AI.",
  ...
  },
  {
    ...
    title: "Labyrinth",
    description:
      "A real-time multiplayer maze game powered by WebSockets. Navigate a procedurally generated 48x48 labyrinth, collect items, and face the Minotaur. All code and assets by me.",
  ...
  },
  {
    ...
    title: "Fishing Game",
    description:
      "A 2D fishing game built with Go and the Ebiten game engine, compiled to WebAssembly for the browser. Cast your line and see what you catch. Code by me, visual assets by Olga Nam, audio assets by AI.",
  ...
  },
  {
    ...
    description:
      "This Portfolio was created using AI, including deployment, hosting, and the React frontend. Portfolio text and content by me.",
